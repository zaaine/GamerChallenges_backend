...
-- AddForeignKey
ALTER TABLE "public"."entry" ADD CONSTRAINT "entry_challenge_id_fkey" FOREIGN KEY ("challenge_id") REFERENCES "public"."challenge"("challenge_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."vote_user_challenge" ADD CONSTRAINT "vote_user_challenge_challenge_id_fkey" FOREIGN KEY ("challenge_id") REFERENCES "public"."challenge"("challenge_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."vote_user_entry" ADD CONSTRAINT "vote_user_entry_entry_id_fkey" FOREIGN KEY ("entry_id") REFERENCES "public"."entry"("entry_id") ON DELETE RESTRICT ON UPDATE CASCADE;
